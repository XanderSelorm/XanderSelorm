...
#### What I'm doing?
- 🏢 Currently working at **Scynett Deutschland GmbH** as a **Frontend Engineer**.
...
- 🖥 **Front-end:** 
  - **📜 Languages:** • `👨‍🔧 JavaScript/Typescript` • `🧚🏻‍♂️ HTML` • `👨🏻‍🎨 CSS` • `🧙🏻 C#` • `👨‍🏭 Dart`

  - **🔬 Frameworks:**  
    - **🌐 Web:** •  • [Next JS](https://nextjs.org) • [Blazor WASM](https://dotnet.microsoft.com/en-us/apps/aspnet/web-apps/blazor)
    - **📱 Mobile:** • [Flutter](https://flutter.dev) • [.NET MAUI](https://docs.microsoft.com/en-us/dotnet/maui/what-is-maui)
    - **🖥 Desktop:** • [Flutter](https://flutter.dev) • [.NET MAUI](https://docs.microsoft.com/en-us/dotnet/maui/what-is-maui)

  - **🗳 UI toolkits:** • [Material UI](https://mui.com) • [Syncfusion](https://www.syncfusion.com) • [MudBlazor](https://mudblazor.com/)
